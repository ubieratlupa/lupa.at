...
task :remote_environment do
  ...
  invoke :'rvm:use', 'ruby-2.7.8@lupa-at'
end
  ...
  deploy do
    ...
    on :launch do
      in_path(fetch(:current_path)) do
        ...
        command %{/home/rails/.rvm/wrappers/ruby-2.7.8@lupa-at/bundle exec pumactl --pidfile /var/www/lupa.at/shared/tmp/pids/puma.pid halt}
      end
    end
  end
